...
namespace NorthwindDao.Dao.Framework
{
    public sealed class ProductsFramework: IProductsDao
    {
        ...
        public ProductsDto Obtener(int Id)
        {
            ...
            try
            {
                ...
                if (Product != null)
                {
                    ...
                    ProductsDto.CategoryID = (int)Product.Category.CategoryID;
                    ProductsDto.QuantityPerUnit = Product.QuantityPerUnit;
                    ProductsDto.UnitPrice = (decimal)Product.UnitPrice;
                    ...
                    ProductsDto.Categories = new CategoriesDto();
                    ProductsDto.Categories.CategoryID = (int)Product.CategoryID;
                    ProductsDto.Categories.CategoryName = Product.Category.CategoryName.ToUpper();
        ...
        public List<ProductsDto> Listar()
        {
            ...
            try
            {
                IEnumerable<Product> ListaProducts = NorthwindEntities.Products.ToList().OrderBy(x => x.ProductName);
